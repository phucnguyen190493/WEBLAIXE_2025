...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            ...
            <form action="{{ isset($bochch) ? route('admin.bochch_update', $bochch->id) : route('admin.bochch_store') }}" method="POST">
                @csrf
                @if(isset($bochch))
                    @method('PUT')
                @endif
                ...
                <div class="form-group">
                    <label>STT</label>
                    <input type="number" step="1" name="stt" value="{{ $bochch->stt ?? '' }}" placeholder="Số thứ tự" class="form-control">
                </div>
                <div class="form-group">
                    ...
                    <select name="BoCauHoiId" class="form-select form-control">
                        ...
                        @foreach($bocauhois as $bocauhoi)
                            ...
                            {{ $bocauhoi->id == $bochch->BoCauHoiId ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select name="CauHoiId" class="form-select form-control">
                        ...
                        @foreach($cauhois as $cauhoi)
                            ...
                            {{ $cauhoi->id == $bochch->CauHoiId ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="active" value="1" {{ isset($bochch) ? ($bochch->active ? 'checked' : '') : '' }}>
                </div>
