                ...
                <table class="table table-striped table-bordered table-hover text-center" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                {{ Str::limit(strip_tags($cauhoi->noidung), 50, ' [...]') }}
                            </td>
                            <td>
                                <input type="checkbox" @checked($cauhoi["cauliet"] == 1) readonly onclick="return false;"/>
                            </td>
                            <td>
                                <input type="checkbox" @checked($cauhoi["active"] == 1) readonly onclick="return false;"/>
                            </td>
                            <td style="display: inline-flex;">
                                <a href="admin/cauhoi/update/{{$cauhoi["id"]}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa
                                </a>
                                <form action="{{ route('admin.cauhoi_destroy', $cauhoi["id"]) }}" method="POST">
                                    @csrf @method('DELETE')
 ...
 <script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#modal-delete').on('show.bs.modal', function (event) {
          ...
          modal.find('.modal-body #delete').attr('href', 'cauhoi/delete/'+iddel);
        })
    });
 </script>
