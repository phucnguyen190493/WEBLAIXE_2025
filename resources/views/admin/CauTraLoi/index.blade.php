                ...
                <table class="table table-striped table-bordered table-hover text-center" id="example">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Câu đúng</th>
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                {{ Str::limit(strip_tags($cautraloi->noidung), 50, ' [...]') }}
                            </td>
                            <td>
                                <input type="checkbox" @checked($cautraloi["caudung"] == 1) readonly onclick="return false;"/>
                            </td>
                            <td>
                                <input type="checkbox" @checked($cautraloi["active"] == 1) readonly onclick="return false;"/>
                            </td>
                            <td style="display: inline-flex;">
                                <a href="admin/cautraloi/update/{{$cautraloi["id"]}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa
                                </a>
                                <!-- <form action="{{ route('admin.cautraloi_destroy', $cautraloi["id"]) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Xoá</button>
                                </form> -->
                                <button data-id="{{$cautraloi["id"]}}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="form-delete">
                ...
                <p>Bạn có chắc muốn xóa Câu trả lời với id <strong id="del-id"></strong> này?</p>
 ...
 <script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#modal-delete').on('show.bs.modal', function (event) {
          ...
          modal.find('.modal-body #delete').attr('href', 'admin/cautraloi/delete/'+iddel);
        })
    });
 </script>
