                ...
                <table class="table table-striped table-bordered table-hover text-center" id="example">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Điểm 5</th>
                            <th class="text-center">Điểm 4</th>
                            <th class="text-center">Điểm 3</th>
                            <th class="text-center">Điểm 2</th>
                            <th class="text-center">Điểm 1</th>
                            <th class="text-center">Điểm 1 min</th>
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <input type="checkbox" @checked($mophong["active"] == 1) readonly onclick="return false;"/>
                            </td>
                            <td style="display: inline-flex;">
                                <a href="admin/mophong/update/{{$mophong["id"]}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa
                                </a>
                                <button data-id="{{$mophong["id"]}}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Xóa Mô phỏng</h4>
        </div>
        <div class="modal-body">
            <form id="form-delete">
                {{ csrf_field() }}
                <input type="hidden" name="id" id="del-id">
                <p>Bạn có chắc muốn xóa Mô phỏng với id <strong id="del-id"></strong> này?</p>
 ...
 <script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#modal-delete').on('show.bs.modal', function (event) {
          ...
          modal.find('.modal-body #delete').attr('href', 'admin/mophong/delete/'+iddel);
        })
    });
 </script>
